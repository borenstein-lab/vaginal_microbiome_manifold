...
m = get_bv_to_ps(med_meta, med_meta$time, med_meta$mt_pseudotime, med_meta$BV_medication, 'Time', 'Pseudo-time', y ~ x, facet = FALSE, 'Medication', c("eq"), c("No" = "#2E9B8F", "Yes" = "#E76F51")) +
